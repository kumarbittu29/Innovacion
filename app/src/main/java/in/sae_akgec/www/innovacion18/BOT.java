...
public class BOT extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(BOT.this, Home.class);
                startActivity(h);
                break;
            case R.id.nav_led:
                Intent i = new Intent(BOT.this, LED.class);
                startActivity(i);
                break;
            case R.id.nav_bot:
                Intent g = new Intent(BOT.this, BOT.class);
                startActivity(g);
                break;
            case R.id.nav_connect:
                Intent s = new Intent(BOT.this, Connect.class);
                startActivity(s);
                break;
            case R.id.nav_developer:
                Intent r = new Intent(BOT.this, Developer.class);
                startActivity(r);
                break;
            case R.id.nav_society:
                Intent t = new Intent(BOT.this, Society.class);
                startActivity(t);
                break;
        }
